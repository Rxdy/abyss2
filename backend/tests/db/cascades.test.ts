...
import { prisma, createUser, createCategory, createTransaction, createRecurring, createResetToken, cleanup } from './helpers.js'
...
describe('suppression d\'un utilisateur (droit à l\'effacement)', () => {
  it('emporte toutes ses données, sans toucher à celles des autres', async () => {
    ...
    for (const table of ['categories', 'transactions', 'recurring_transactions', 'password_reset_tokens']) {
